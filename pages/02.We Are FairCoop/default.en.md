...
<div class= "container">
   ...
   <dic class="image">         
 <img src="/images/ibc2.jpg" alt="IBC2" width="500" height="600">
  </div>
    </div>
...
Welcome on the website of the local subnode LsN Las Alpujarras of the global cooperative community FairCoop,<br> here you will find in furture all the Information about our work and activities as local exchange point for cooperative projects in and arround las Alpujarras.
<br>
...
<h2>Following projects are associated in with our activities: <h2>
<div class="list">
<ul>
    <li><a href="https://lasalpujarras.fair.coop/de/projects/permacoop">PermaCoop<a> </li>
    <li><a href="https://sites.google.com/site/lesjardinsdizan/home">Les Jardin d'Izan<a> </li>
        <li><a href="http://agroalpujarra.com/">Agroalpujarra<a> </li>
        
    <li><a href="#">Skyearth<a> </li>
        </div>
...
<br><br>
   ...
   <br>
    ...
    locally in Cigarones evey wednesday on the local market.<br>
   ...
   <div class="agreement">
<h1> Agreement </h1>
We the Assembly Foundation facilitators of 
<a href="https://hub.disroot.org/channel/lasalpujarras"> LsN; Las Alpujarras  </a> 
    wish to make the following known: <br><br>

 "Most of us, live in a world not of our making but one that has been moulded over thousands of years of exploitation and injustice.<br><br>
 
 Our world is shaped by the forces of greed, capitalism and materialism, where maximum production and optimum profits are vigorously pursued, making life a misery for many and putting us and the environment at risk.<br>
<br>
The system is ultimately controlled by the rich and powerful, the capitalists and bureaucrats, through the use of many mechanisms such as ownership of the economy (making people slaves to a job) and control of the media (creating a passive culture)." [[Source]](www.radicalroutes.org.uk/aims-and-principles.html)<br> <br>
...
<h3>4. Autonomy and Independence</h3><br>
