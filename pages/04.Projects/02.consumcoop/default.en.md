...
Here you will find all the news and informations about the ConsumCoop.
    ...
    <div class="block">
    	<h3> we would like to propose you to use the webservice of the techcollective <a href="https://bazar.komun.org/en/">  					Komun </a> </h3>
    				...
    				<br>
    Have a look on the <a href="https://bazar.komun.org/"> <b> Bazar </b></a> and discover allready the different produts allready available everywhere in the world. With the registration on the website as seller you have the possibility to offer and buy products in Euros but also in other social currencies. <br>
